...
<div class="layui-form layui-form-pane">
    <div class="layui-row">
        ...
        <div class="layui-col-xs3 layui-btn-group btn_group_right">
            <button class="layui-btn layui-btn-primary" onclick="inventory();">盘点</button>
...
<script type="text/javascript" charset="utf-8">
    var sys=<?php echo json_encode(get_sys(['enable_batch'])); ?>;
    var formfield=<?php echo get_formfield('roomcheck_main','jqgrid'); ?>;
...
<script src="/skin/js/public/jqgrid.locale-cn.js" type="text/javascript" charset="utf-8"></script>
...
<script src="/skin/js/main/room_check.js" type="text/javascript" charset="utf-8"></script>
</div>
