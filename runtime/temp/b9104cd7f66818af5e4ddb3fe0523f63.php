...
<script type="text/javascript" charset="utf-8">
    var formfield=<?php echo get_formfield('unit_form','layui'); ?>;
</script>
<script src="/skin/js/unit/main.js" type="text/javascript" charset="utf-8"></script>
</div>
