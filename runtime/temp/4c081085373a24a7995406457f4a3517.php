            ...
            <div class="layui-row layui-col-space3">
                ...
                <div class="layui-col-xs3">
                    <div class="layui-form-item remove_margin reset_item">
                        ...
                        <div class="layui-input-block">
                            <div id="nod_customer" class="selectpage" nod="s|customer" tip="全部客户" url="/index/service/customer_list" checkbox></div>
                        </div>
                    </div>
                </div>
            ...
            <div class="layui-row layui-col-space3" show>
                <div class="layui-col-xs3">
                    <div class="layui-form-item remove_margin reset_item">
                        ...
                        <div class="layui-input-block">
                            <div id="nod_warehouse" class="selectpage" nod="s|warehouse" tip="全部仓库" url="/index/service/warehouse_list" checkbox></div>
                        </div>
                    </div>
                </div>
                <div class="layui-col-xs3">
...
<script type="text/html" id="bar_info">
    <div class="layui-btn-group">
        <button class="layui-btn layui-btn-primary layui-btn-sm" lay-event="min_prints">小票</button>
