...
<script type="text/javascript" charset="utf-8">
    var formfield=<?php echo get_formfield('room_form','layui'); ?>;
...
<script src="/skin/js/main/room.js" type="text/javascript" charset="utf-8"></script>
</div>
