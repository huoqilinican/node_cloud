<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:74:"D:\nodcloud-master\nodcloud-master/application/index\view\gather\main.html";i:1689602947;s:72:"D:\nodcloud-master\nodcloud-master\application\index\view\main\main.html";i:1689602947;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
    ...
    <div class="push_data">
        <div class="layui-row">
                ...
                <div class="layui-row layui-col-space3">
                    ...
                    <div class="layui-col-xs4">
                        <div class="layui-form-item remove_margin reset_item">
                            ...
                            <div class="layui-input-block">
                                <input type="text" class="layui-input" id="number" placeholder="请输入单据编号" value="<?php echo (isset($class['number']) && ($class['number'] !== '')?$class['number']:get_number('SKD')); ?>" />
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="set_btn">
                ...
                <?php else: if(empty($class['type']['nod']) || (($class['type']['nod'] instanceof \think\Collection || $class['type']['nod'] instanceof \think\Paginator ) && $class['type']['nod']->isEmpty())): if((get_root('gather_edit'))): ?>
                            <button class="layui-btn layui-btn-normal" onclick="save(<?php echo isset($class['id'])?$class['id']:'0'; ?>);">保存单据</button>
                        <?php endif; if((get_root('gather_auditing'))): ?>
                            <button class="layui-btn layui-btn-primary" onclick="auditing(<?php echo isset($class['id'])?$class['id']:'0'; ?>,true);">审核单据</button>
                        <?php endif; else: if((get_root('gather_auditing'))): ?>
...
<script type="text/javascript" charset="utf-8">
    ...
    var user_opt=<?php echo get_sys(['user_opt']); ?>;
    var account_arr=<?php echo get_account(); ?>;
    var formfield=<?php echo get_formfield('gather_main','jqgrid'); ?>;
...
<script src="/skin/js/gather/table.js" type="text/javascript" charset="utf-8"></script>
<script src="/skin/js/gather/main.js" type="text/javascript" charset="utf-8"></script>
</div>
