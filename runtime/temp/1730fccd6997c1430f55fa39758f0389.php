    ...
    <div class="push_data">
        <div class="layui-row">
                ...
                <div class="layui-row layui-col-space3">
                    ...
                    <div class="layui-col-xs4">
                        <div class="layui-form-item remove_margin reset_item">
                            ...
                            <div class="layui-input-block">
                                <input type="text" class="layui-input" id="number" placeholder="请输入单据编号" value="<?php echo (isset($class['number']) && ($class['number'] !== '')?$class['number']:get_number('XHTHD')); ?>" />
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="set_btn">
                ...
                <?php else: if(empty($class['type']['nod']) || (($class['type']['nod'] instanceof \think\Collection || $class['type']['nod'] instanceof \think\Paginator ) && $class['type']['nod']->isEmpty())): if((get_root('resale_edit'))): ?>
                            <button class="layui-btn layui-btn-normal" onclick="save(<?php echo isset($class['id'])?$class['id']:'0'; ?>);">保存单据</button>
                        <?php endif; if((get_root('resale_auditing'))): ?>
                            <button class="layui-btn layui-btn-primary" onclick="auditing(<?php echo isset($class['id'])?$class['id']:'0'; ?>,true);">审核单据</button>
                        <?php endif; else: if((get_root('resale_auditing'))): ?>
...
<script type="text/javascript" charset="utf-8">
    var price_type='sell';//初始化价格类型
    var hide_field={hide_field:'buy,retail'};//设置隐藏的字段信息
    ...
    var formfield=<?php echo get_formfield('resale_main','jqgrid'); ?>;
...
<script src="/skin/js/resale/table.js" type="text/javascript" charset="utf-8"></script>
<script src="/skin/js/resale/main.js" type="text/javascript" charset="utf-8"></script>
</div>
