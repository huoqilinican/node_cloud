                ...
                <div class="layui-col-xs3">
                    <div class="layui-form-item remove_margin reset_item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" class="layui-input" id="s|name" placeholder="请输入客户名称">
                        </div>
                    </div>
                </div>
                <div class="layui-col-xs3">
                    <div class="layui-form-item remove_margin reset_item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" class="layui-input" id="s|number" placeholder="请输入客户编号">
                        </div>
                    </div>
                </div>
                <div class="layui-col-xs3">
            ...
            <div class="layui-row layui-col-space3" show>
                ...
                <div class="layui-col-xs3">
                    <div class="layui-form-item remove_margin reset_item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" class="layui-input" id="s|add" placeholder="请输入客户地址">
                        </div>
                    </div>
                </div>
                <div class="layui-col-xs3">
...
<script type="text/html" id="bar_info">
    <div class="layui-btn-group">
        <button class="layui-btn layui-btn-primary layui-btn-sm" lay-event="integral">积分</button>
...
<script type="text/javascript" charset="utf-8">
    var formfield=<?php echo get_formfield('customer_form','layui'); ?>;
</script>
<script src="/skin/js/customer/main.js" type="text/javascript" charset="utf-8"></script>
</div>
