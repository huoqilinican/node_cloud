                ...
                <div class="layui-col-xs3">
                    <div class="layui-form-item remove_margin reset_item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" class="layui-input" id="s|name" placeholder="请输入仓库名称">
                        </div>
                    </div>
                </div>
                <div class="layui-col-xs3">
                    <div class="layui-form-item remove_margin reset_item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" class="layui-input" id="s|number" placeholder="请输入仓库编号">
                        </div>
                    </div>
                </div>
                <div class="layui-col-xs3">
            ...
            <div class="layui-row layui-col-space3" show>
                ...
                <div class="layui-col-xs3">
                    <div class="layui-form-item remove_margin reset_item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" class="layui-input" id="s|add" placeholder="请输入仓库地址">
                        </div>
                    </div>
                </div>
                <div class="layui-col-xs3">
...
<script type="text/javascript" charset="utf-8">
    var formfield=<?php echo get_formfield('warehouse_form','layui'); ?>;
</script>
<script src="/skin/js/warehouse/main.js" type="text/javascript" charset="utf-8"></script>
</div>
