            ...
            <div class="layui-row layui-col-space3" show>
                ...
                <div class="layui-col-xs3">
                    <div class="layui-form-item remove_margin reset_item">
                        ...
                        <div class="layui-input-block">
                            <div id="nod_towarehouse" class="selectpage" nod="s|towarehouse" tip="全部仓库" url="/index/service/warehouse_list" checkbox></div>
                        </div>
                    </div>
                </div>
                <div class="layui-col-xs3">
