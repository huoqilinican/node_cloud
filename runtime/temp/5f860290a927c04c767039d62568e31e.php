...
<link rel="stylesheet" href="/skin/css/main/pop_goods.css" type="text/css" media="all" />
<div class="layui-form layui-form-pane">
    <div class="layui-row">
        <div class="layui-col-xs10" id="search_data">
            ...
            <div class="layui-row layui-col-space3" show>
                ...
                <div class="layui-col-xs4">
                    <div class="layui-form-item remove_margin reset_item">
                        ...
                        <div class="layui-input-block">
                            <div id="s_unit" class="selectpage"></div>
                        </div>
                    </div>
                </div>
        </div>
        ...
        <div class="layui-col-xs2 layui-btn-group btn_group_right">
...
<script type="text/javascript" charset="utf-8">
    var hide_field='<?php echo (\think\Request::instance()->get('hide_field') ?: ""); ?>';
    var formfield=hidelayuifield(<?php echo get_formfield('base_goods','layui'); ?>,hide_field);//设置隐藏字段信息
...
<script src="/skin/js/main/base_goods.js" type="text/javascript" charset="utf-8"></script>
</div>
