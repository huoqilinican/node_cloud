...
<script type="text/javascript" charset="utf-8">
    var formfield=<?php echo get_formfield('roomwarning_form','layui'); ?>;
...
<script src="/skin/js/main/room_warning.js" type="text/javascript" charset="utf-8"></script>
</div>
