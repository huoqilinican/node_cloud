                ...
                <div class="layui-col-xs3">
                    <div class="layui-form-item remove_margin reset_item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" class="layui-input" id="s|name" placeholder="请输入属性名称">
                        </div>
                    </div>
                </div>
                <div class="layui-col-xs3">
...
<script type="text/javascript" charset="utf-8">
    var formfield=<?php echo get_formfield('attribute_form','layui'); ?>;
</script>
<script src="/skin/js/attribute/main.js" type="text/javascript" charset="utf-8"></script>
</div>
